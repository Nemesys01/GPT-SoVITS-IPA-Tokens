...
def change_sovits_weights(sovits_path, prompt_language=None, text_language=None):
    ...
    dict_language = dict_language_v1 if version == "v1" else dict_language_v2
    print(f"##> Languages supported: {dict_language.keys()}")
...
def clean_text_inf(text, language, version):
    ...
    # The function is in the __init__ and just seems to map directly onto the symbols.py list
    print("Symbols to tokens...")
...
def get_tts_wav(
    ...
    texts = text.split("\n")
    print(f"##> Before process: {texts}")
    texts = process_text(texts)
    print(f"##> After processing: {texts}")
    ...
    for i_text, text in enumerate(texts):
        ...
        print(f"##> Get phones and bert:\t{phones2}\n\t{bert2}")
        ...
        print(f"##> all_phoneme_len: {all_phoneme_len}")
        print(f"##> all_phoneme_ids: {all_phoneme_ids}")
